...
public class Projectile : MonoBehaviour
{
    ...
    protected virtual void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        //Damage Logic
        if (collision.gameObject.GetComponent<Enemy>() != null) { collision.gameObject.GetComponent<Enemy>().TakeDamage(20 /*Esto deberia ser projectile damage, convertir a int?*/); }
    }
}
